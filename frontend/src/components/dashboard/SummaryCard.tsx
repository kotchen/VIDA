...
/** Card-free summary body shared by SummaryCard and InsightsCard. */
export function SummaryContent({
  summary,
  onRegenerate,
  regenerating = false,
}: Omit<SummaryProps, "loading">) {
  if (summary === null) {
    return (
      <div className="flex flex-col items-start gap-3">
        <p className="text-sm text-muted-warm">Summary is not available yet.</p>
        {onRegenerate ? (
